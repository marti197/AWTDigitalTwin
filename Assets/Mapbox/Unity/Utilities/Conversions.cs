...
namespace Mapbox.Unity.Utilities
{
	...
	public static class Conversions
	{
		...
		public static Vector2d StringToLatLon(string s)
		{
			...
			// Bugfix: Resolved ArgumentException for an incorrect number of arguments.
			var latLongReplacedWithDot = s.Replace(',', '.');
            var latLonSplit = latLongReplacedWithDot.Split(new[] { ". " }, StringSplitOptions.None);
