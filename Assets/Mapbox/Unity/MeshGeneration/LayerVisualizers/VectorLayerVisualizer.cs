...
namespace Mapbox.Unity.MeshGeneration.Interfaces
{
    ...
    public class VectorLayerVisualizer : LayerVisualizerBase
    {
        ...
        public override void SetProperties(VectorSubLayerProperties properties)
        {
            ...
            // Controls the live traffic visualization 
            var toggleSettingsController = FindObjectOfType<ToggleSettingsController>();

            if (toggleSettingsController != null)
            {
                if (toggleSettingsController.IsEnabled && properties.coreOptions.layerName == "traffic")
                {
                    properties.coreOptions.isActive = true;
                }
                else if (!toggleSettingsController.IsEnabled && properties.coreOptions.layerName == "traffic")
                {
                    properties.coreOptions.isActive = false;
                }
            }
